    ...
    <div className="Home">
      ...
      <div className="content-box">
        <header className="Home-header">
          ...
          <p>Hi, I'm Michael Parker. I graduated from UCF in 2025 with a Bachelors Degree in Computer Science. My main focuses during my undergrad were AI and Software Development</p>
          <footer>
